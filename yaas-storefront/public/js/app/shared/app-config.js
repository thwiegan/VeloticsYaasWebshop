...
angular.module('ds.appconfig', [])
    ...
    .constant('appConfig', {
        ...
        storeTenant: function(){
            ...
            //    tenantId = /*StartProjectId*/ 'veloticswebshop' /*EndProjectId*/;
            //}
            return tenantId;
        },
        ...
        clientId: function() {
            ...
            return /*StartClientId*/ 'KJ4PRd3SxFeGzHtSQeLNpq3EJqvdzZ6Q' /*EndClientId*/;
        },

        redirectURI: function() {
            // Dynamic RedirectURI is configured and replaced by build script, see gruntfile.
            return /*StartRedirectURI*/ 'https://veloticswebshopdeva6402f209.hana.ondemand.com/webshop' /*EndRedirectURI*/;
        }
