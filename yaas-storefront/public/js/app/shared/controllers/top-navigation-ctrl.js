...
/** Handles interactions with the top menu (mobile menu, mobile search, mobile cart & full screen cart icon) */
    .controller('TopNavigationCtrl', ['$scope', '$rootScope', '$state', '$controller', '$timeout', 'GlobalData', 'CartSvc', 'AuthSvc', 'AuthDialogManager', 'CategorySvc', 'settings', 'YGoogleSignin','ipCookie',

        function ($scope, $rootScope, $state, $controller, $timeout, GlobalData, CartSvc, AuthSvc, AuthDialogManager, CategorySvc, settings, YGoogleSignin, ipCookie) {
            ...
            $scope.toggleCart = function () {
                ...
                ipCookie("showCart", $rootScope.showCart);
            };
            ...
            $scope.login = function(dOpts, opts) {
                ...
                // ipCookie('goto', $state.current);
                // ipCookie('goto_params', {});
