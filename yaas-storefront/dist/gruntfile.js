...
module.exports = function (grunt) {
    ...
    var JS_DIR = 'public/js/app',
        ...
        PROJECT_ID = grunt.option('pid') || 'veloticswebshop',
        CLIENT_ID = grunt.option('cid') || 'KJ4PRd3SxFeGzHtSQeLNpq3EJqvdzZ6Q',
        REDIRECT_URI = grunt.option('ruri') || 'https://veloticswebshopdeva6402f209.hana.ondemand.com/webshop',
