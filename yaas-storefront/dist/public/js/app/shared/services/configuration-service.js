...
angular.module('ds.shared')
    .factory('ConfigSvc', ['$rootScope', '$q', 'settings', 'GlobalData', 'AuthSvc', 'AccountSvc', 'CartSvc', 'CategorySvc', 'SiteSettingsREST', 'ipCookie',
        function ($rootScope, $q, settings, GlobalData, AuthSvc, AccountSvc, CartSvc, CategorySvc, SiteSettingsREST, ipCookie) {
                            ...
                            siteSettingPromise.then(function (site) {
                                ...
                                if (AuthSvc.isAuthenticated()) {
                                    ...
                                    AccountSvc.account().then(function (account) {
                                        ...
                                        if(account) {
                                            CartSvc.refreshCartAfterLogin(account.id).then( function() {
