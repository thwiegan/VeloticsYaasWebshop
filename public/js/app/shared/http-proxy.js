...
angular.module('ds.httpproxy', [])
    ...
    .factory('interceptor', ['$q', '$injector', 'settings', 'TokenSvc', 'httpQueue', 'GlobalData', 'SiteConfigSvc', '$location', '$rootScope', 'ipCookie',
        function ($q, $injector, settings, TokenSvc, httpQueue, GlobalData, siteConfig, $location, $rootScope, ipCookie) {
