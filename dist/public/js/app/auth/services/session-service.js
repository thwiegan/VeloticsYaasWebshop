...
angular.module('ds.auth')
    ...
    .factory('SessionSvc', ['AccountSvc', 'CartSvc', 'GlobalData', '$state', '$stateParams', 'settings', '$rootScope', 'ipCookie',
        function (AccountSvc, CartSvc, GlobalData, $state, $stateParams, settings, $rootScope, ipCookie) {
            ...
            function commonPostLogin(context){
                CartSvc.refreshCartAfterLogin(GlobalData.customerAccount.id).then(function() {
